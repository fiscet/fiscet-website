...
CLIP Energy clips a single non-invasive sensor onto the main cable — no electrician, no rewiring — and runs a neural network on top that, every two seconds, "decomposes" the total consumption and recognizes the individual appliances.
